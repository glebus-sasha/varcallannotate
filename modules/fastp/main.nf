...
process FASTP{
    ...
    publishDir "${params.outdir}/${workflow.start.format('yyyy-MM-dd_HH-mm-ss')}_${params.launch_name}/FASTP"
    cpus 10
//	  debug true
//    errorStrategy 'ignore'
    ...
    output:
    tuple val(sid), path("${sid}_trimmed_R1.fastq.gz"), path("${sid}_trimmed_R2.fastq.gz"), emit: trimmed_reads
